...
enum PizzaToppings {
    CHEESE("Cheese", 1.0), PEPPERONI("Pepperoni", 1.5), MUSHROOMS("Mushrooms", 1.2), ONIONS("Onions", 0.8);
...
enum SideDish {
    FRIES("Fries", 3.0), SALAD("Salad", 4.0), WINGS("Wings", 5.0), BREADSTICKS("Breadsticks", 3.5);
